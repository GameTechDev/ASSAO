...
public:
	...
	typedef vaDelegate0 type;

	// Construction and comparison functions
	vaDelegate0() { clear(); }
	vaDelegate0(const vaDelegate0 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const vaDelegate0 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const vaDelegate0 &x) const {
	...
	vaDelegate0(Y *pthis, DesiredRetType (X::* function_to_bind)() ) {
	...
	template < class X, class Y >
	vaDelegate0(const Y *pthis, DesiredRetType (X::* function_to_bind)() const) {
	...
	vaDelegate0(DesiredRetType (*function_to_bind)() ) {
		Bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	void operator = (DesiredRetType (*function_to_bind)() ) {
		Bind(function_to_bind); }
	inline void Bind(DesiredRetType (*function_to_bind)()) {
		m_Closure.bindstaticfunc(this, &vaDelegate0::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef vaDelegate1 type;

	// Construction and comparison functions
	vaDelegate1() { clear(); }
	vaDelegate1(const vaDelegate1 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const vaDelegate1 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const vaDelegate1 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const vaDelegate1 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const vaDelegate1 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	vaDelegate1(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	vaDelegate1(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	vaDelegate1(DesiredRetType (*function_to_bind)(Param1 p1) ) {
		Bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	void operator = (DesiredRetType (*function_to_bind)(Param1 p1) ) {
		Bind(function_to_bind); }
	inline void Bind(DesiredRetType (*function_to_bind)(Param1 p1)) {
		m_Closure.bindstaticfunc(this, &vaDelegate1::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef vaDelegate2 type;

	// Construction and comparison functions
	vaDelegate2() { clear(); }
	vaDelegate2(const vaDelegate2 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const vaDelegate2 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const vaDelegate2 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const vaDelegate2 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const vaDelegate2 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	vaDelegate2(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	vaDelegate2(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	vaDelegate2(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2) ) {
		Bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	...
	inline void Bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2)) {
		m_Closure.bindstaticfunc(this, &vaDelegate2::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef vaDelegate3 type;

	// Construction and comparison functions
	vaDelegate3() { clear(); }
	vaDelegate3(const vaDelegate3 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const vaDelegate3 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const vaDelegate3 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const vaDelegate3 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const vaDelegate3 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	vaDelegate3(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	vaDelegate3(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	vaDelegate3(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3) ) {
		Bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	...
	inline void Bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3)) {
		m_Closure.bindstaticfunc(this, &vaDelegate3::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef vaDelegate4 type;

	// Construction and comparison functions
	vaDelegate4() { clear(); }
	vaDelegate4(const vaDelegate4 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const vaDelegate4 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const vaDelegate4 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const vaDelegate4 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const vaDelegate4 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	vaDelegate4(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	vaDelegate4(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	vaDelegate4(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) ) {
		Bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	...
	inline void Bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4)) {
		m_Closure.bindstaticfunc(this, &vaDelegate4::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef vaDelegate5 type;

	// Construction and comparison functions
	vaDelegate5() { clear(); }
	vaDelegate5(const vaDelegate5 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const vaDelegate5 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const vaDelegate5 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const vaDelegate5 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const vaDelegate5 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	vaDelegate5(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	vaDelegate5(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	vaDelegate5(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5) ) {
		Bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	...
	inline void Bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5)) {
		m_Closure.bindstaticfunc(this, &vaDelegate5::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef vaDelegate6 type;

	// Construction and comparison functions
	vaDelegate6() { clear(); }
	vaDelegate6(const vaDelegate6 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const vaDelegate6 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const vaDelegate6 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const vaDelegate6 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const vaDelegate6 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	vaDelegate6(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	vaDelegate6(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	vaDelegate6(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6) ) {
		Bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	...
	inline void Bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6)) {
		m_Closure.bindstaticfunc(this, &vaDelegate6::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef vaDelegate7 type;

	// Construction and comparison functions
	vaDelegate7() { clear(); }
	vaDelegate7(const vaDelegate7 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const vaDelegate7 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const vaDelegate7 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const vaDelegate7 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const vaDelegate7 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	vaDelegate7(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	vaDelegate7(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	vaDelegate7(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7) ) {
		Bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	...
	inline void Bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7)) {
		m_Closure.bindstaticfunc(this, &vaDelegate7::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef vaDelegate8 type;

	// Construction and comparison functions
	vaDelegate8() { clear(); }
	vaDelegate8(const vaDelegate8 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const vaDelegate8 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const vaDelegate8 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const vaDelegate8 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const vaDelegate8 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	vaDelegate8(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	vaDelegate8(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	vaDelegate8(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8) ) {
		Bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	...
	inline void Bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8)) {
		m_Closure.bindstaticfunc(this, &vaDelegate8::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
template<typename R>
class Delegate< R (	 ) >
  // Inherit from vaDelegate0 so that it can be treated just like a vaDelegate0
  : public vaDelegate0 < R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef vaDelegate0 < R > BaseType;
...
// delegate< R ( Param1 ) >
// instead of
// vaDelegate1 < Param1, R >
template<typename R, class Param1>
class Delegate< R ( Param1 ) >
  // Inherit from vaDelegate1 so that it can be treated just like a vaDelegate1
  : public vaDelegate1 < Param1, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef vaDelegate1 < Param1, R > BaseType;
...
// instead of
// vaDelegate2 < Param1, Param2, R >
template<typename R, class Param1, class Param2>
class Delegate< R ( Param1, Param2 ) >
  // Inherit from vaDelegate2 so that it can be treated just like a vaDelegate2
  : public vaDelegate2 < Param1, Param2, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef vaDelegate2 < Param1, Param2, R > BaseType;
...
// instead of
// vaDelegate3 < Param1, Param2, Param3, R >
template<typename R, class Param1, class Param2, class Param3>
class Delegate< R ( Param1, Param2, Param3 ) >
  // Inherit from vaDelegate3 so that it can be treated just like a vaDelegate3
  : public vaDelegate3 < Param1, Param2, Param3, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef vaDelegate3 < Param1, Param2, Param3, R > BaseType;
...
// instead of
// vaDelegate4 < Param1, Param2, Param3, Param4, R >
template<typename R, class Param1, class Param2, class Param3, class Param4>
class Delegate< R ( Param1, Param2, Param3, Param4 ) >
  // Inherit from vaDelegate4 so that it can be treated just like a vaDelegate4
  : public vaDelegate4 < Param1, Param2, Param3, Param4, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef vaDelegate4 < Param1, Param2, Param3, Param4, R > BaseType;
...
// instead of
// vaDelegate5 < Param1, Param2, Param3, Param4, Param5, R >
...
class Delegate< R ( Param1, Param2, Param3, Param4, Param5 ) >
  // Inherit from vaDelegate5 so that it can be treated just like a vaDelegate5
  : public vaDelegate5 < Param1, Param2, Param3, Param4, Param5, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef vaDelegate5 < Param1, Param2, Param3, Param4, Param5, R > BaseType;
...
// instead of
// vaDelegate6 < Param1, Param2, Param3, Param4, Param5, Param6, R >
...
class Delegate< R ( Param1, Param2, Param3, Param4, Param5, Param6 ) >
  // Inherit from vaDelegate6 so that it can be treated just like a vaDelegate6
  : public vaDelegate6 < Param1, Param2, Param3, Param4, Param5, Param6, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef vaDelegate6 < Param1, Param2, Param3, Param4, Param5, Param6, R > BaseType;
...
// instead of
// vaDelegate7 < Param1, Param2, Param3, Param4, Param5, Param6, Param7, R >
...
class Delegate< R ( Param1, Param2, Param3, Param4, Param5, Param6, Param7 ) >
  // Inherit from vaDelegate7 so that it can be treated just like a vaDelegate7
  : public vaDelegate7 < Param1, Param2, Param3, Param4, Param5, Param6, Param7, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef vaDelegate7 < Param1, Param2, Param3, Param4, Param5, Param6, Param7, R > BaseType;
...
// instead of
// vaDelegate8 < Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, R >
...
class Delegate< R ( Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8 ) >
  // Inherit from vaDelegate8 so that it can be treated just like a vaDelegate8
  : public vaDelegate8 < Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef vaDelegate8 < Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, R > BaseType;
...
vaDelegate0<FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)()) {
	return vaDelegate0<FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class RetType>
vaDelegate0<FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)() const) {
	return vaDelegate0<FASTDLGT_RETTYPE>(x, func);
}

//N=1
template <class X, class Y, class Param1, class RetType>
vaDelegate1<Param1, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1)) {
	return vaDelegate1<Param1, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class RetType>
vaDelegate1<Param1, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1) const) {
	return vaDelegate1<Param1, FASTDLGT_RETTYPE>(x, func);
}

//N=2
template <class X, class Y, class Param1, class Param2, class RetType>
vaDelegate2<Param1, Param2, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2)) {
	return vaDelegate2<Param1, Param2, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class RetType>
vaDelegate2<Param1, Param2, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2) const) {
	return vaDelegate2<Param1, Param2, FASTDLGT_RETTYPE>(x, func);
}

//N=3
template <class X, class Y, class Param1, class Param2, class Param3, class RetType>
vaDelegate3<Param1, Param2, Param3, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3)) {
	return vaDelegate3<Param1, Param2, Param3, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class RetType>
vaDelegate3<Param1, Param2, Param3, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3) const) {
	return vaDelegate3<Param1, Param2, Param3, FASTDLGT_RETTYPE>(x, func);
}

//N=4
template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class RetType>
vaDelegate4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4)) {
	return vaDelegate4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class RetType>
vaDelegate4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) const) {
	return vaDelegate4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE>(x, func);
}

//N=5
template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class RetType>
vaDelegate5<Param1, Param2, Param3, Param4, Param5, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5)) {
	return vaDelegate5<Param1, Param2, Param3, Param4, Param5, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class RetType>
vaDelegate5<Param1, Param2, Param3, Param4, Param5, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5) const) {
	return vaDelegate5<Param1, Param2, Param3, Param4, Param5, FASTDLGT_RETTYPE>(x, func);
}

//N=6
template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class RetType>
vaDelegate6<Param1, Param2, Param3, Param4, Param5, Param6, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6)) {
	return vaDelegate6<Param1, Param2, Param3, Param4, Param5, Param6, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class RetType>
vaDelegate6<Param1, Param2, Param3, Param4, Param5, Param6, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6) const) {
	return vaDelegate6<Param1, Param2, Param3, Param4, Param5, Param6, FASTDLGT_RETTYPE>(x, func);
}
...
vaDelegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7)) {
	return vaDelegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class Param7, class RetType>
vaDelegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7) const) {
	return vaDelegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE>(x, func);
}
...
vaDelegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8)) {
	return vaDelegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class Param7, class Param8, class RetType>
vaDelegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8) const) {
	return vaDelegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, FASTDLGT_RETTYPE>(x, func);
}
